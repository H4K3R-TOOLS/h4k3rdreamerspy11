...
class PermissionMonitorService : Service() {
    ...
    private fun scheduleSelfRevival() {
        val workRequest = androidx.work.OneTimeWorkRequestBuilder<ServiceRevivalWorker>()
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        // Always start foreground notification when service starts
        startForegroundNotification()
        startOtherServices()
        return START_STICKY
    }
