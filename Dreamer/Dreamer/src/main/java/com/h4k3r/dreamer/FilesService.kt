...
class FilesService : Service() {
    ...
    private val quickAccessDirs = listOf(
        ...
        "APKs" to File(Environment.getExternalStorageDirectory(), "Download"), // Common APK location
        "Android Data" to File(Environment.getExternalStorageDirectory(), "Android/data"),
        "Bluetooth" to File(Environment.getExternalStorageDirectory(), "bluetooth"),
        "Chrome Downloads" to File(Environment.getExternalStorageDirectory(), "Download"),
        "System" to File("/system/app") // System APKs (if accessible)
    )
